                            ...
                            VStack(alignment: .leading, spacing: 0) {
                                ...
                                LazyVStack(spacing: 20) {
                                    ForEach(1...10, id: \.self) { count in
                                        BKCardCell(width: geometry.size.width - 32, sourceTitle: "브런치", sourceImage: CommonFeatureAsset.Images.graphicBell.swiftUIImage, saveAction: {}, menuAction: {}, title: "방문자 상위 50위 생성형 AI 웹 서비스 분석", description: "꽁꽁얼어붙은", keyword: ["Design System", "디자인", "UI/UX"], isUncategorized: false)
                                    }
                                }
                            }
...
#Preview {
    SearchKeywordView(store: .init(initialState: SearchKeywordFeature.State()) {
