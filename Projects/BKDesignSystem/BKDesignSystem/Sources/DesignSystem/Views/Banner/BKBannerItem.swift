...
private extension BKBannerItem {
  var logoImage: Image {
    switch type {
    case .instruction:
      BKDesignSystem.Images.icoCircleAppLogo
  
    case .kakaoChannel:
      BKDesignSystem.Images.icoCircleKakao
      
    case .linkSavePromotionDetail:
      BKDesignSystem.Images.promotionDetailBannerIcon
      
    case .linkSavePromotionVerify:
      BKDesignSystem.Images.promotionVerifyBannerIcon
    }
  }
