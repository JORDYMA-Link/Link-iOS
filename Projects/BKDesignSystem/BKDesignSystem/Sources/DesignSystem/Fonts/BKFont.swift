...
public enum BKFont {
  ...
  public func fontName(size: CGFloat) -> UIFont {
    switch self {
    case .semiBold: return BKDesignSystemFontFamily.Pretendard.semiBold.font(size: size)
    case .regular: return BKDesignSystemFontFamily.Pretendard.regular.font(size: size)
    case .light: return BKDesignSystemFontFamily.Pretendard.light.font(size: size)
    }
  }
  
  public func fontName(size: CGFloat) -> Font {
    switch self {
    case .semiBold: return BKDesignSystemFontFamily.Pretendard.semiBold.swiftUIFont(size: size)
    case .regular: return BKDesignSystemFontFamily.Pretendard.regular.swiftUIFont(size: size)
    case .light: return BKDesignSystemFontFamily.Pretendard.light.swiftUIFont(size: size)
    }
  }
}
