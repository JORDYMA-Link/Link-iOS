...
let project = Project.make(
    ...
    targets: [
        ...
        .core(client: .BKNetworkClient, factory: .init(
            sources: "BKNetworkClient/Sources/**",
            dependencies: [
                .external(externalDependency: .moya),
                .shared,
                .core(client: .KeychainClient)
            ]
        )),
        .core(client: .KeychainClient, factory: .init(
            sources: "KeychainClient/Sources/**",
            dependencies: [
                .shared
            ]
        )),
        .core(client: .UserDefaultsClient, factory: .init(
            sources: "UserDefaultsClient/Sources/**",
            dependencies: [
                .shared
            ]
        )),
